...
public:
    ...
    virtual std::string perform_Action(std::vector<std::shared_ptr<Player>> &) override; // Override and overloaded function to apply card abilities to the game ; in this case , reduce the score of each card to 1
