...
public:
    ...
    virtual std::string perform_Action(std::vector<std::shared_ptr<Card>> &) override; // Override and overloaded function to apply card abilities to the game ; in this case, 3 points are added to the card or cards with the highest score
